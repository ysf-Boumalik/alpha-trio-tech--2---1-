    ...
    <>
      ...
      <section className="min-h-screen bg-white text-gray-900 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-gray-100 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold text-center mb-4">{t("About AlphaTrio Tech")}</h1>
          <p className="text-gray-600 dark:text-gray-400 text-center mb-16 max-w-2xl mx-auto">
            {t("Building innovative technology solutions since 2016")}
          </p>

          {/* Company Story */}
          <div className="bg-white dark:bg-slate-800 p-8 rounded-lg border border-slate-200 dark:border-slate-700 mb-16">
            <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">{t("Our Story")}</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              {t("AlphaTrio Tech was founded with a mission to bridge the gap between cutting-edge technology and practical business solutions. We believe that technology should empower businesses, not complicate them.")}
            </p>
            <p className="text-gray-700 dark:text-gray-300">
              {t("Over the years, we've helped dozens of companies transform their operations through innovative IT solutions, automation, and AI-powered systems. Our team is dedicated to delivering excellence in every project.")}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {[
              { title: t("Results-Focused"), desc: t("We measure success by your business outcomes") },
              { title: t("Innovation"), desc: t("Always exploring new technologies and approaches") },
              { title: t("Collaboration"), desc: t("Working closely with you every step of the way") },
            ].map((value, i) => (
              <div
                key={i}
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {team.map((member, i) => (
                ...
                >
                  ...
                  <p className="text-purple-500 dark:text-purple-400 text-sm mb-2">{member.role}</p>
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-20">
            {[
              { num: "50+", label: t("Projects") },
              { num: "30+", label: t("Clients") },
              { num: "5+", label: t("Years") },
              { num: "100%", label: t("Satisfaction") },
            ].map((stat, i) => (
              <div key={i} className="text-center">
                <div className="text-4xl font-bold text-purple-500 dark:text-purple-400 mb-2">{stat.num}</div>
